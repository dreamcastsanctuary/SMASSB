...
public class IdSystem {
    ...
    public static async Task BuildId(SocketSlashCommand command,
        ...
        if (roleIds.Contains(1527905937329881158)) badgesToDraw.Add((LoadBadges("tanzaku_gold.png", 150, 50),  new Point(1520, 620)));
        if (roleIds.Contains(1527905990329110669)) badgesToDraw.Add((LoadBadges("tanzaku_silver.png", 150, 50),  new Point(1650, 620)));
        if (roleIds.Contains(1527906014060609586)) badgesToDraw.Add((LoadBadges("tanzaku_slip.png", 150, 50),  new Point(1680, 620)));
