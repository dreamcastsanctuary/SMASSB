    ...
    public async Task PostShopContents(SocketSlashCommand command) {
        ...
        var containerSakura = new ContainerBuilder()
            ...
            .AddComponent(new ActionRowBuilder()
                .WithButton($"Buy {items[0]} :: ¥14000", customId: $"buy_item_1_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[1]} :: ¥8000", customId: $"buy_item_2_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[2]} :: ¥3000", customId: $"buy_item_3_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[3]} :: ¥4000", customId: $"buy_item_4_{command.Channel.Id}", style: ButtonStyle.Secondary)
            );
        ...
        var containerSango = new ContainerBuilder()
            ...
            .AddComponent(new SeparatorBuilder().WithIsDivider(true).WithSpacing(SeparatorSpacingSize.Large))
            .AddComponent(new ActionRowBuilder()
                .WithButton($"Buy {items[0]} :: ¥14000", customId: $"buy_item_5_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[1]} :: ¥8000", customId: $"buy_item_6_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[2]} :: ¥3000", customId: $"buy_item_7_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[3]} :: ¥4000", customId: $"buy_item_8_{command.Channel.Id}", style: ButtonStyle.Secondary)
            );
        ...
        var containerTech = new ContainerBuilder()
            ...
            .AddComponent(new SeparatorBuilder().WithIsDivider(true).WithSpacing(SeparatorSpacingSize.Large))
            .AddComponent(new ActionRowBuilder()
                .WithButton($"Buy {items[0]} :: ¥11000", customId: $"buy_item_9_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[1]} :: ¥8000", customId: $"buy_item_10_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy {items[3]} :: ¥4000", customId: $"buy_item_11_{command.Channel.Id}", style: ButtonStyle.Secondary)
            );
        ...
        var containerIds = new ContainerBuilder()
            ...
            .AddComponent(new SeparatorBuilder().WithIsDivider(true).WithSpacing(SeparatorSpacingSize.Large))
            .AddComponent(new ActionRowBuilder()
                .WithButton($"Buy Pink {items[4]} :: ¥10000", customId: $"buy_item_12_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy Red {items[4]} :: ¥10000", customId: $"buy_item_13_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy Green {items[4]} :: ¥10000", customId: $"buy_item_14_{command.Channel.Id}", style: ButtonStyle.Secondary)
                .WithButton($"Buy Blue {items[4]} :: ¥10000", customId: $"buy_item_15_{command.Channel.Id}", style: ButtonStyle.Secondary)
            );
