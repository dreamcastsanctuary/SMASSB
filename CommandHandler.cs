...
public class CommandHandler {
    ...
    public async Task RegisterCommands(SocketGuild guild) {
        ...
        commands.Add(new SlashCommandBuilder()
            .WithName("addpoints")
            .WithDescription("Adds points to one or more members.")
            .AddOption("enlisted", ApplicationCommandOptionType.String, "The @ of the enlisted (mention as many as you like, space-separated).", isRequired: true)
        ...
        Cacheable<IMessageChannel, ulong> channel, SocketReaction reaction)
    {
        ...
        else if (reaction.MessageId is 1524131916624953598)
        {
            // tanabata
            if (reaction.Emote is Emote emote)
            {
