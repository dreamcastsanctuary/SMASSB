...
public class CommandHandler {
    ...
    public async Task RegisterCommands() {
        ...
        var addAppsOption = new SlashCommandOptionBuilder()
            .WithName("add_apps")
        ...
        var removeAppsOption = new SlashCommandOptionBuilder()
        ...
        var caseTypeOption = new SlashCommandOptionBuilder()
            .WithName("case_type")
        ...
        var charmTypeOption = new SlashCommandOptionBuilder()
            .WithName("charm_type")
        ...
        var wallpaperTypeOption = new SlashCommandOptionBuilder()
        ...
        commands.Add(new SlashCommandBuilder()
            ...
            .AddOption(addAppsOption)
            .AddOption(removeAppsOption)
            .AddOption(caseTypeOption)
            .AddOption(charmTypeOption)
            .AddOption(wallpaperTypeOption));

        commands.Add(new SlashCommandBuilder()
            .WithName("debugworkcell")
            .WithDescription("Shows or edits another member's Work Cellphone.")
            .AddOption("member", ApplicationCommandOptionType.User, "The member whose Work Cellphone to show/edit.", isRequired: true)
            .AddOption(addAppsOption)
            .AddOption(removeAppsOption)
            .AddOption(caseTypeOption)
            .AddOption(charmTypeOption)
